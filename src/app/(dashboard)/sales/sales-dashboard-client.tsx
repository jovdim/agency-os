...
import { Phone, CaretDown as ChevronDown, CaretUp as ChevronUp, MagnifyingGlass as Search, XCircle, CalendarDots as CalendarClock, Note as StickyNote, ArrowRight, Eye, PaperPlaneTilt as Send, Plus, Clock, CalendarBlank as Calendar, Receipt, Envelope as Mail, MapPin, Skull, Check, DotsThree as MoreHorizontal, PencilSimple as Pencil, CaretRight as ChevronRight, GitCommit as GitCommitVertical, FileText, Question as HelpCircle, ArrowCounterClockwise as RotateCcw, Info, Briefcase, Fire as Flame, PhoneCall } from "@phosphor-icons/react/ssr";
