  ...
  return (
    <tr
      ...
      className={cn(
        ...
        // Interactive rows: deeper hover bg + cursor.
        // The left accent bar is drawn via globals.css on the first cell so the
        // table layout doesn't shift (no border, no translate).
